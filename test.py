...
"""
DONE
    1   |   PONER LA EL pathDirectorioActual en todas las funciones de app.py (GUSTAVO)
    1   |   MOSTRAR DIRECTORIOS EN ls (JORGE)
    1   |   MOSTRAR INDOOS EN ls (JORGE)
    1   |   MOSTRAR CARPETA ANTERIOR EN ls (JORGE)
"""